...
Webflow.require('ix').init([
  {"slug":"scale-hero-image","name":"Scale Hero Image","value":{"style":{"opacity":0,"scale":0.98,"x":"0px","y":"4px"},"triggers":[{"type":"load","stepsA":[{"opacity":1,"transition":"transform 800ms ease-in-out 0ms, opacity 800ms ease-in-out 0ms","scale":1,"x":"0px","y":"0px"}],"stepsB":[]}]}},
  {"slug":"feature-row-fade-in","name":"Feature Row Fade In","value":{"style":{"opacity":0,"x":"0px","y":"26px"},"triggers":[{"type":"scroll","stepsA":[{"opacity":1,"transition":"transform 500ms ease 0ms, opacity 500ms ease 0ms","x":"0px","y":"0px"}],"stepsB":[]}]}}
]);
